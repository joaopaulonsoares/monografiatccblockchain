...
\section{Conceitos de segurança}
    ...
    A criptografia é o componente mais importante do \textit{blokchain}.A criptografia é certamente um campo de pesquisa em si mesmo, e é baseada em técnicas matemáticas. Houveram muitas falhas relatadas em carteiras e trocas de informações devido ao \textit{design} mais fraco ou implementações criptográficas frágeis \cite{beginnig_blockchain_bikramaditya}.
